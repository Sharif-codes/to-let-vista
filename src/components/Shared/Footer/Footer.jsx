    ...
    <footer className="footer footer-center p-10 bg-black text-primary-content">
      <aside>
        ...
        <p className="font-bold">
          To-Let Hub. <br /> To-Let Management System
        </p>
        <p>Copyright © Sharif Bhuyan 2024 - All right reserved</p>
      </aside>
      <nav>
        <div className="grid grid-flow-col gap-4">
          <RiVisaFill className="text-3xl"></RiVisaFill>
          <FaCcMastercard className="text-3xl"></FaCcMastercard>
          <SiAmericanexpress className="text-3xl"></SiAmericanexpress>
        </div>
      </nav>
    </footer>
  )
