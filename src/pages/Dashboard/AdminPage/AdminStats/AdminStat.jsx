...
const AdminStat = () => {
    ...
    const myProperty= totalProperety?.length
    const myPending= pendingBooking?.filter(item=> item.status== "accepted")
    const myBooking= pendingBooking?.filter(item=> item.status== "booked")
    console.log("my total", myProperty);

    const available= myProperty - (myPending?.length + myBooking?.length)
    const data = [
        ["Task", "Hours per Day"],
        ["Available", available],
            ...
            <div>
                <div className="stats shadow">
                    ...
                    <div className="stat">
                        ...
                        <div className="stat-value text-primary">{myProperty}</div>
                    </div>
